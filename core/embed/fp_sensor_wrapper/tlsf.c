...
static block_header_t* block_locate_free(control_t* control, size_t size)
{
    ...
    if ( size )
    {
        ...
        ** Note that we don't need to check sl, since it comes from a modulo operation that guarantees it's
        *always in range.
        */
