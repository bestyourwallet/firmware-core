...
/// def flashled(enable: bool) -> None:
///     """
///     Camera flash
///     """
STATIC mp_obj_t mod_trezorio_flashled(mp_obj_t enable) {
  bool led_enabled = mp_obj_is_true(enable);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorio_flashled_obj,
                                 mod_trezorio_flashled);
...
STATIC const mp_rom_map_elem_t mod_trezorio_camera_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_flashled), MP_ROM_PTR(&mod_trezorio_flashled_obj)},
};
