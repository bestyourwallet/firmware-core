...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_check(mp_obj_t mnemonic) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_se_acl16_check_obj,
                                 mod_trezorcrypto_se_acl16_check);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_seed(size_t n_args,
                                               const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_trezorcrypto_se_acl16_seed_obj,
                                           1, 2,
                                           mod_trezorcrypto_se_acl16_seed);
...
///     Generate seed from mnemonic and passphrase.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_cardano_seed(size_t n_args,
                                                       const mp_obj_t *args) {
  mp_buffer_info_t phrase = {0};
  mp_get_buffer_raise(args[0], &phrase, MP_BUFFER_READ);
  const char *ppassphrase = phrase.len > 0 ? phrase.buf : "";
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_cardano_seed_obj, 1, 2,
    mod_trezorcrypto_se_acl16_cardano_seed);
...
///     start session.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_start_session(mp_obj_t session_id) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_se_acl16_start_session_obj,
                                 mod_trezorcrypto_se_acl16_start_session);

/// def end_session() -> None:
///     """
///     end current session.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_end_session(void) {
  se_sessionClose();
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_end_session_obj,
                                 mod_trezorcrypto_se_acl16_end_session);

/// def clear_session() -> None:
///     """
///     clear all sessions.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_clear_session(void) {
  se_sessionClear();
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_clear_session_obj,
                                 mod_trezorcrypto_se_acl16_clear_session);

/// def get_session_state() -> bytes:
///     """
///     get current session secret state.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_get_session_state(void) {
  uint8_t status[2] = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_get_session_state_obj,
    mod_trezorcrypto_se_acl16_get_session_state);

/// def get_session_current_id() -> bytes:
///     """
///     get current session id.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_get_session_current_id(void) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_get_session_current_id_obj,
    mod_trezorcrypto_se_acl16_get_session_current_id);

/// def session_is_open() -> bool:
///     """
///     get current session secret state.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_session_is_open(void) {
  if (!se_session_is_open()) {
    return mp_const_false;
  }
  return mp_const_true;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_session_is_open_obj,
                                 mod_trezorcrypto_se_acl16_session_is_open);

/// def get_session_type() -> int:
///     """
///     get the type of current session.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_get_session_type(void) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_get_session_type_obj,
                                 mod_trezorcrypto_se_acl16_get_session_type);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_nist256p1_sign(size_t n_args,
                                                         const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_nist256p1_sign_obj, 2, 3,
    mod_trezorcrypto_se_acl16_nist256p1_sign);
...
///     Uses secret key to produce the signature of the digest.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_secp256k1_sign_digest(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_secp256k1_sign_digest_obj, 2, 4,
    mod_trezorcrypto_se_acl16_secp256k1_sign_digest);
...
///     Uses secret key to produce the signature of the digest.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_bip340_sign(mp_obj_t secret_key,
                                                      mp_obj_t digest) {
  // mp_buffer_info_t sk = {0};
  mp_buffer_info_t dig = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorcrypto_se_acl16_bip340_sign_obj,
                                 mod_trezorcrypto_se_acl16_bip340_sign);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_ed25519_sign(size_t n_args,
                                                       const mp_obj_t *args) {
  mp_buffer_info_t sk = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_ed25519_sign_obj, 2, 3,
    mod_trezorcrypto_se_acl16_ed25519_sign);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_ecdh(mp_obj_t curve,
                                               mp_obj_t public_key) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorcrypto_se_acl16_ecdh_obj,
                                 mod_trezorcrypto_se_acl16_ecdh);

/// def uncompress_pubkey(curve: str, pubkey: bytes) -> bytes:
///     """
///     Uncompress public.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_uncompress_pubkey(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_uncompress_pubkey_obj,
    mod_trezorcrypto_se_acl16_uncompress_pubkey);
...
///     Uses secret key to produce the signature of message.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_aes256_encrypt(size_t n_args,
                                                         const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_aes256_encrypt_obj, 2, 3,
    mod_trezorcrypto_se_acl16_aes256_encrypt);
...
///     Uses secret key to produce the signature of message.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_aes256_decrypt(size_t n_args,
                                                         const mp_obj_t *args) {
  mp_buffer_info_t data = {0};
  mp_buffer_info_t value = {0};
  mp_get_buffer_raise(args[0], &data, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_aes256_decrypt_obj, 2, 3,
    mod_trezorcrypto_se_acl16_aes256_decrypt);

/// def slip21_node() -> bytes:
///     """
///     Returns slip21 node.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_slip21_node(void) {
  vstr_t vstr = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_slip21_node_obj,
                                 mod_trezorcrypto_se_acl16_slip21_node);

/// def slip21_fido_node() -> bytes:
///     """
///     Returns slip21 fido node, seed without passphrase.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_slip21_fido_node(void) {
  vstr_t vstr = {0};
  vstr_init_len(&vstr, 64);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_slip21_fido_node_obj,
                                 mod_trezorcrypto_se_acl16_slip21_fido_node);
...
///     authorization_set.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_authorization_set(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_authorization_set_obj,
    mod_trezorcrypto_se_acl16_authorization_set);
...
///     authorization_get.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_authorization_get_type(void) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_authorization_get_type_obj,
    mod_trezorcrypto_se_acl16_authorization_get_type);
...
///     authorization_get.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_authorization_get_data(void) {
  uint32_t data_len = 0;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_authorization_get_data_obj,
    mod_trezorcrypto_se_acl16_authorization_get_data);
...
///     authorization clear.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_authorization_clear(void) {
  se_authorization_clear();
  return mp_const_none;
}

STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_authorization_clear_obj,
    mod_trezorcrypto_se_acl16_authorization_clear);
...
///     Read certificate.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_read_certificate(void) {
  uint8_t cert[1024];
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorcrypto_se_acl16_read_certificate_obj,
                                 mod_trezorcrypto_se_acl16_read_certificate);

/// def sign_message(msg: bytes) -> bytes:
///     """
///     Sign message.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_sign_message(mp_obj_t msg) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_se_acl16_sign_message_obj,
                                 mod_trezorcrypto_se_acl16_sign_message);

/// def derive_xmr(
///     path: Sequence[int]
///     digest: bytes,
/// ) -> tuple[bytes, bytes]:
STATIC mp_obj_t mod_trezorcrypto_se_acl16_derive_xmr(mp_obj_t path) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_se_acl16_derive_xmr_obj,
                                 mod_trezorcrypto_se_acl16_derive_xmr);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_derive_xmr_private(mp_obj_t deriv,
                                                             mp_obj_t index) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_derive_xmr_private_obj,
    mod_trezorcrypto_se_acl16_derive_xmr_private);
...
///     base + H_s(derivation || varint(output_index))
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_xmr_get_tx_key(mp_obj_t rand,
                                                         mp_obj_t hash) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorcrypto_se_acl16_xmr_get_tx_key_obj,
                                 mod_trezorcrypto_se_acl16_xmr_get_tx_key);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_seed(size_t n_args,
                                                    const mp_obj_t *args) {
  if (n_args > 0) {
    // generate with a progress callback
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_se_acl16_fido_seed_obj, 0, 1,
    mod_trezorcrypto_se_acl16_fido_seed);
...
///     U2F Register.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_u2f_register(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_fido_u2f_register_obj,
    mod_trezorcrypto_se_acl16_fido_u2f_register);
...
///     """
STATIC mp_obj_t
mod_trezorcrypto_se_acl16_u2f_gen_handle_and_node(mp_obj_t app_id) {
  mp_buffer_info_t app_id_b = {0};
  mp_get_buffer_raise(app_id, &app_id_b, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_se_acl16_u2f_gen_handle_and_node_obj,
    mod_trezorcrypto_se_acl16_u2f_gen_handle_and_node);
...
///     U2F Validate Handle.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_u2f_validate(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_fido_u2f_validate_obj,
    mod_trezorcrypto_se_acl16_fido_u2f_validate);
...
///     U2F Authenticate.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_u2f_authenticate(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_trezorcrypto_se_acl16_fido_u2f_authenticate_obj,
    mod_trezorcrypto_se_acl16_fido_u2f_authenticate);
...
///     """
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_sign_digest(mp_obj_t digest) {
  mp_buffer_info_t dig = {0};
  mp_get_buffer_raise(digest, &dig, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_se_acl16_fido_sign_digest_obj,
                                 mod_trezorcrypto_se_acl16_fido_sign_digest);
...
///     """
STATIC mp_obj_t
mod_trezorcrypto_se_acl16_fido_att_sign_digest(mp_obj_t digest) {
  mp_buffer_info_t dig = {0};
  mp_get_buffer_raise(digest, &dig, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_se_acl16_fido_att_sign_digest_obj,
    mod_trezorcrypto_se_acl16_fido_att_sign_digest);

/// def fido_delete_all_credentials() -> None:
///     """
///     Delete all FIDO2 credentials.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_fido_delete_all_credentials(void) {
  se_delete_all_fido2_credentials();
  return mp_const_none;
}

STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_fido_delete_all_credentials_obj,
    mod_trezorcrypto_se_acl16_fido_delete_all_credentials);

/// def get_pin_passphrase_space() -> int:
///     """
///     get the number of available pin-passphrase slots.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_get_pin_passphrase_space(void) {
  uint8_t space = 0;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_get_pin_passphrase_space_obj,
    mod_trezorcrypto_se_acl16_get_pin_passphrase_space);

/// def get_pin_passphrase_current() -> str | None:
///     """
///     Return the current passphrase bound to the active passphrase PIN.
///     Returns None if reading fails or the value is invalid.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_get_pin_passphrase_current(void) {
  char passphrase[PASSPHRASE_MAX_LENGTH] = {0};
  uint8_t passphrase_len = 0;

  if (!se_get_pin_passphrase_current(passphrase, &passphrase_len)) {
    return mp_const_none;
  }

  if (passphrase_len == 0 || passphrase_len > PASSPHRASE_MAX_LENGTH) {
    return mp_const_none;
  }

  if (!utf8_check((const byte *)passphrase, passphrase_len)) {
    return mp_const_none;
  }

  return mp_obj_new_str(passphrase, passphrase_len);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_se_acl16_get_pin_passphrase_current_obj,
    mod_trezorcrypto_se_acl16_get_pin_passphrase_current);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_save_pin_passphrase(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_trezorcrypto_se_acl16_save_pin_passphrase_obj,
    mod_trezorcrypto_se_acl16_save_pin_passphrase);
...
///     """
STATIC mp_obj_t
mod_trezorcrypto_se_acl16_delete_pin_passphrase(mp_obj_t passphrase_pin) {
  mp_buffer_info_t passphrase_pin_buf = {0};
  mp_get_buffer_raise(passphrase_pin, &passphrase_pin_buf, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_se_acl16_delete_pin_passphrase_obj,
    mod_trezorcrypto_se_acl16_delete_pin_passphrase);
...
///     """
STATIC mp_obj_t
mod_trezorcrypto_se_acl16_check_passphrase_btc_test_address(mp_obj_t address) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_se_acl16_check_passphrase_btc_test_address_obj,
    mod_trezorcrypto_se_acl16_check_passphrase_btc_test_address);
...
///     Returns True on success, False on failure.
///     """
STATIC mp_obj_t mod_trezorcrypto_se_acl16_change_pin_passphrase(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_se_acl16_change_pin_passphrase_obj,
    mod_trezorcrypto_se_acl16_change_pin_passphrase);

/// FIDO2_CRED_COUNT_MAX: int

STATIC const mp_rom_map_elem_t mod_trezorcrypto_se_acl16_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_se_acl16)},
    {MP_ROM_QSTR(MP_QSTR_check),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_check_obj)},
    {MP_ROM_QSTR(MP_QSTR_seed),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_seed_obj)},
    {MP_ROM_QSTR(MP_QSTR_cardano_seed),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_cardano_seed_obj)},
    {MP_ROM_QSTR(MP_QSTR_start_session),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_start_session_obj)},
    {MP_ROM_QSTR(MP_QSTR_end_session),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_end_session_obj)},
    {MP_ROM_QSTR(MP_QSTR_clear_session),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_clear_session_obj)},
    {MP_ROM_QSTR(MP_QSTR_get_session_state),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_get_session_state_obj)},
    {MP_ROM_QSTR(MP_QSTR_get_session_current_id),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_get_session_current_id_obj)},
    {MP_ROM_QSTR(MP_QSTR_session_is_open),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_session_is_open_obj)},
    {MP_ROM_QSTR(MP_QSTR_get_session_type),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_get_session_type_obj)},
    {MP_ROM_QSTR(MP_QSTR_nist256p1_sign),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_nist256p1_sign_obj)},
    {MP_ROM_QSTR(MP_QSTR_secp256k1_sign_digest),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_secp256k1_sign_digest_obj)},
    {MP_ROM_QSTR(MP_QSTR_bip340_sign),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_bip340_sign_obj)},
    {MP_ROM_QSTR(MP_QSTR_ed25519_sign),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_ed25519_sign_obj)},
    {MP_ROM_QSTR(MP_QSTR_ecdh),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_ecdh_obj)},
    {MP_ROM_QSTR(MP_QSTR_uncompress_pubkey),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_uncompress_pubkey_obj)},
    {MP_ROM_QSTR(MP_QSTR_aes256_encrypt),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_aes256_encrypt_obj)},
    {MP_ROM_QSTR(MP_QSTR_aes256_decrypt),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_aes256_decrypt_obj)},
    {MP_ROM_QSTR(MP_QSTR_slip21_node),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_slip21_node_obj)},
    {MP_ROM_QSTR(MP_QSTR_slip21_fido_node),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_slip21_fido_node_obj)},
    {MP_ROM_QSTR(MP_QSTR_authorization_set),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_authorization_set_obj)},
    {MP_ROM_QSTR(MP_QSTR_authorization_get_type),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_authorization_get_type_obj)},
    {MP_ROM_QSTR(MP_QSTR_authorization_get_data),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_authorization_get_data_obj)},
    {MP_ROM_QSTR(MP_QSTR_authorization_clear),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_authorization_clear_obj)},
    {MP_ROM_QSTR(MP_QSTR_read_certificate),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_read_certificate_obj)},
    {MP_ROM_QSTR(MP_QSTR_sign_message),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_sign_message_obj)},
    {MP_ROM_QSTR(MP_QSTR_derive_xmr),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_derive_xmr_obj)},
    {MP_ROM_QSTR(MP_QSTR_derive_xmr_private),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_derive_xmr_private_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_get_tx_key),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_xmr_get_tx_key_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_seed),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_seed_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_u2f_register),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_u2f_register_obj)},
    {MP_ROM_QSTR(MP_QSTR_u2f_gen_handle_and_node),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_u2f_gen_handle_and_node_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_u2f_authenticate),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_u2f_authenticate_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_u2f_validate),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_u2f_validate_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_sign_digest),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_sign_digest_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_att_sign_digest),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_att_sign_digest_obj)},
    {MP_ROM_QSTR(MP_QSTR_fido_delete_all_credentials),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_fido_delete_all_credentials_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_get_pin_passphrase_space),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_get_pin_passphrase_space_obj)},
    {MP_ROM_QSTR(MP_QSTR_get_pin_passphrase_current),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_get_pin_passphrase_current_obj)},
    {MP_ROM_QSTR(MP_QSTR_save_pin_passphrase),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_save_pin_passphrase_obj)},
    {MP_ROM_QSTR(MP_QSTR_delete_pin_passphrase),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_delete_pin_passphrase_obj)},
    {MP_ROM_QSTR(MP_QSTR_check_passphrase_btc_test_address),
     MP_ROM_PTR(
         &mod_trezorcrypto_se_acl16_check_passphrase_btc_test_address_obj)},
    {MP_ROM_QSTR(MP_QSTR_change_pin_passphrase),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_change_pin_passphrase_obj)},
...
STATIC MP_DEFINE_CONST_DICT(mod_trezorcrypto_se_acl16_globals,
                            mod_trezorcrypto_se_acl16_globals_table);

STATIC const mp_obj_module_t mod_trezorcrypto_se_acl16_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&mod_trezorcrypto_se_acl16_globals,
};
