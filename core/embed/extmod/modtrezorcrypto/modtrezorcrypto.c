...
#if USE_ACL16_WALLET_CRYPTO && !USE_ACL16
#error "USE_ACL16_WALLET_CRYPTO requires USE_ACL16"
#endif
...
#if USE_ACL16
    {MP_ROM_QSTR(MP_QSTR_se_acl16),
     MP_ROM_PTR(&mod_trezorcrypto_se_acl16_module)},
#endif
};
