...
typedef enum {
  ...
  BOOT_TARGET_MSC = 0x11223340,
  BOOT_TARGET_BOARDLOADER = 0x64616F62,
  BOOT_TARGET_BOOTLOADER = 0x746F6F62,

  BOOT_LOCAL_START = 0x89890001,  // -----------------------
  BOOT_LOCAL_FIRMWARE = 0x89890002,
  BOOT_LOCAL_MSC = 0x89890004,
  BOOT_LOCAL_UPDATE = 0x89890003,
  BOOT_LOCAL_BOARDLOADER = 0x89890001,
  BOOT_LOCAL_END = 0x89890004,  // -----------------------------

} volatile BOOT_TARGET;

typedef enum {
  DEBUG_PORT_VCP = 0,
  DEBUG_PORT_RTT = 0x746F6F62,
} volatile DEBUG_PORT;

#define BOOT_TARGET_FLAG_ADDR ((BOOT_TARGET *)(0x30040000 - 4))
#define DEBUG_PORT_FLAG_ADDR ((DEBUG_PORT *)(0x30040000 - 8))
