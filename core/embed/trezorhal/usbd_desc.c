...
#define USBD_MANUFACTURER_STRING      "UKey"
#define USBD_PRODUCT_HS_STRING        "UKey Core 26 Boardloader HS"
#define USBD_PRODUCT_FS_STRING        "UKey Core 26 Boardloader FS"
