...
#define FLASH_OTP_BLOCK_ACL16_SESSION_KEY 8
...
#define FLASH_OTP_BLOCK_SE_1_PUBKEY1 16
#define FLASH_OTP_BLOCK_SE_1_PUBKEY2 17
#define FLASH_OTP_BLOCK_BLE_PUBKEY1 24
#define FLASH_OTP_BLOCK_BLE_PUBKEY2 25
#define FLASH_OTP_BLOCK_RESET_FLAG 26
