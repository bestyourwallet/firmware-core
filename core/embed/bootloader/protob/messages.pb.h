...
typedef enum _MessageType { 
    ...
    MessageType_MessageType_UkeyGetFeatures = 10025, 
    MessageType_MessageType_UkeyFeatures = 10026, 
    ...
    MessageType_MessageType_GetHardwareHash = 30111, 
    MessageType_MessageType_HardwareHash = 30112, 
    MessageType_MessageType_FactoryGetChallenge = 30113, 
    MessageType_MessageType_FactoryChallenge = 30114, 
    MessageType_MessageType_FactoryAuthenticate = 30115 
} MessageType;

typedef enum _UKeyDeviceType { 
    UKeyDeviceType_CLASSIC = 0, 
    UKeyDeviceType_CLASSIC1S = 1, 
    UKeyDeviceType_MINI = 2, 
    UKeyDeviceType_TOUCH = 3, 
    UKeyDeviceType_PRO = 5 
} UKeyDeviceType;

typedef enum _UKeySeType { 
    UKeySeType_ACL16 = 0, 
    UKeySeType_SE608A = 1 
} UKeySeType;

typedef enum _UKeySEState { 
    UKeySEState_BOOT = 0, 
    UKeySEState_APP = 1 
} UKeySEState;
...
typedef struct _FactoryGetChallenge { 
    char dummy_field;
} FactoryGetChallenge;
...
typedef struct _GetHardwareHash { 
    char dummy_field;
} GetHardwareHash;
...
typedef struct _UkeyGetFeatures { 
    char dummy_field;
} UkeyGetFeatures;
...
typedef PB_BYTES_ARRAY_T(32) FactoryAuthenticate_challenge_t;
typedef PB_BYTES_ARRAY_T(32) FactoryAuthenticate_hardware_hash_t;
typedef PB_BYTES_ARRAY_T(64) FactoryAuthenticate_signature_t;
typedef struct _FactoryAuthenticate { 
    uint32_t protocol_version; 
    uint32_t key_id; 
    FactoryAuthenticate_challenge_t challenge; 
    FactoryAuthenticate_hardware_hash_t hardware_hash; 
    uint32_t init_state; 
    FactoryAuthenticate_signature_t signature; 
} FactoryAuthenticate;

typedef PB_BYTES_ARRAY_T(32) FactoryChallenge_challenge_t;
typedef PB_BYTES_ARRAY_T(32) FactoryChallenge_hardware_hash_t;
typedef struct _FactoryChallenge { 
    uint32_t protocol_version; 
    FactoryChallenge_challenge_t challenge; 
    FactoryChallenge_hardware_hash_t hardware_hash; 
    uint32_t init_state; 
} FactoryChallenge;
...
typedef PB_BYTES_ARRAY_T(32) Features_ukey_board_hash_t;
typedef PB_BYTES_ARRAY_T(32) Features_ukey_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) Features_ukey_se01_hash_t;
typedef PB_BYTES_ARRAY_T(32) Features_ukey_firmware_hash_t;
typedef struct _Features { 
    ...
    bool backup_only; 
    bool has_ukey_version;
    char ukey_version[32]; 
    ...
    bool has_ukey_device_type;
    UKeyDeviceType ukey_device_type; 
    bool has_ukey_se_type;
    UKeySeType ukey_se_type; 
    bool has_ukey_board_version;
    char ukey_board_version[32]; 
    bool has_ukey_board_hash;
    Features_ukey_board_hash_t ukey_board_hash; 
    bool has_ukey_boot_version;
    char ukey_boot_version[16]; 
    bool has_ukey_boot_hash;
    Features_ukey_boot_hash_t ukey_boot_hash; 
    bool has_ukey_se01_version;
    char ukey_se01_version[16]; 
    bool has_ukey_se01_hash;
    Features_ukey_se01_hash_t ukey_se01_hash; 
    bool has_ukey_se01_build_id;
    char ukey_se01_build_id[8]; 
    bool has_ukey_firmware_version;
    char ukey_firmware_version[16]; 
    bool has_ukey_firmware_hash;
    Features_ukey_firmware_hash_t ukey_firmware_hash; 
    bool has_ukey_firmware_build_id;
    char ukey_firmware_build_id[64]; 
    bool has_ukey_serial_no;
    char ukey_serial_no[32]; 
    bool has_ukey_boot_build_id;
    char ukey_boot_build_id[8]; 
    bool has_ukey_ble_name;
    char ukey_ble_name[32]; 
    bool has_ukey_ble_version;
    char ukey_ble_version[16]; 
    bool has_ukey_se02_version;
    char ukey_se02_version[16]; 
    bool has_ukey_se03_version;
    char ukey_se03_version[16]; 
    bool has_ukey_se04_version;
    char ukey_se04_version[16]; 
    bool has_ukey_se01_state;
    UKeySEState ukey_se01_state; 
    bool has_ukey_se02_state;
    UKeySEState ukey_se02_state; 
    bool has_ukey_se03_state;
    UKeySEState ukey_se03_state; 
    bool has_ukey_se04_state;
    UKeySEState ukey_se04_state; 
} Features;
...
typedef PB_BYTES_ARRAY_T(32) HardwareHash_hardware_hash_t;
typedef struct _HardwareHash { 
    HardwareHash_hardware_hash_t hardware_hash; 
} HardwareHash;
...
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_board_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_firmware_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_ble_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se01_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se02_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se03_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se04_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se01_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se02_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se03_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) UkeyFeatures_ukey_se04_boot_hash_t;
typedef struct _UkeyFeatures { 
    bool has_ukey_device_type;
    UKeyDeviceType ukey_device_type; 
    bool has_ukey_board_version;
    char ukey_board_version[32]; 
    ...
    char ukey_firmware_version[16]; 
    bool has_ukey_board_hash;
    UkeyFeatures_ukey_board_hash_t ukey_board_hash; 
    bool has_ukey_boot_hash;
    UkeyFeatures_ukey_boot_hash_t ukey_boot_hash; 
    bool has_ukey_firmware_hash;
    UkeyFeatures_ukey_firmware_hash_t ukey_firmware_hash; 
    bool has_ukey_board_build_id;
    char ukey_board_build_id[8]; 
    bool has_ukey_boot_build_id;
    char ukey_boot_build_id[8]; 
    bool has_ukey_firmware_build_id;
    char ukey_firmware_build_id[64]; 
    ...
    bool has_ukey_ble_version;
    char ukey_ble_version[16]; 
    bool has_ukey_ble_build_id;
    char ukey_ble_build_id[8]; 
    bool has_ukey_ble_hash;
    UkeyFeatures_ukey_ble_hash_t ukey_ble_hash; 
    bool has_ukey_se_type;
    UKeySeType ukey_se_type; 
    bool has_ukey_se01_state;
    UKeySEState ukey_se01_state; 
    ...
    char ukey_se04_version[16]; 
    bool has_ukey_se01_hash;
    UkeyFeatures_ukey_se01_hash_t ukey_se01_hash; 
    bool has_ukey_se02_hash;
    UkeyFeatures_ukey_se02_hash_t ukey_se02_hash; 
    bool has_ukey_se03_hash;
    UkeyFeatures_ukey_se03_hash_t ukey_se03_hash; 
    bool has_ukey_se04_hash;
    UkeyFeatures_ukey_se04_hash_t ukey_se04_hash; 
    bool has_ukey_se01_build_id;
    char ukey_se01_build_id[8]; 
    bool has_ukey_se02_build_id;
    char ukey_se02_build_id[8]; 
    bool has_ukey_se03_build_id;
    char ukey_se03_build_id[8]; 
    bool has_ukey_se04_build_id;
    char ukey_se04_build_id[8]; 
    bool has_ukey_se01_boot_version;
    char ukey_se01_boot_version[16]; 
    bool has_ukey_se02_boot_version;
    char ukey_se02_boot_version[16]; 
    bool has_ukey_se03_boot_version;
    char ukey_se03_boot_version[16]; 
    bool has_ukey_se04_boot_version;
    char ukey_se04_boot_version[16]; 
    bool has_ukey_se01_boot_hash;
    UkeyFeatures_ukey_se01_boot_hash_t ukey_se01_boot_hash; 
    bool has_ukey_se02_boot_hash;
    UkeyFeatures_ukey_se02_boot_hash_t ukey_se02_boot_hash; 
    bool has_ukey_se03_boot_hash;
    UkeyFeatures_ukey_se03_boot_hash_t ukey_se03_boot_hash; 
    bool has_ukey_se04_boot_hash;
    UkeyFeatures_ukey_se04_boot_hash_t ukey_se04_boot_hash; 
    bool has_ukey_se01_boot_build_id;
    char ukey_se01_boot_build_id[8]; 
    bool has_ukey_se02_boot_build_id;
    char ukey_se02_boot_build_id[8]; 
    bool has_ukey_se03_boot_build_id;
    char ukey_se03_boot_build_id[8]; 
    bool has_ukey_se04_boot_build_id;
    char ukey_se04_boot_build_id[8]; 
} UkeyFeatures;
...
#define _MessageType_MAX MessageType_MessageType_FactoryAuthenticate
#define _MessageType_ARRAYSIZE ((MessageType)(MessageType_MessageType_FactoryAuthenticate+1))

#define _UKeyDeviceType_MIN UKeyDeviceType_CLASSIC
#define _UKeyDeviceType_MAX UKeyDeviceType_PRO
#define _UKeyDeviceType_ARRAYSIZE ((UKeyDeviceType)(UKeyDeviceType_PRO+1))

#define _UKeySeType_MIN UKeySeType_ACL16
#define _UKeySeType_MAX UKeySeType_SE608A
#define _UKeySeType_ARRAYSIZE ((UKeySeType)(UKeySeType_SE608A+1))

#define _UKeySEState_MIN UKeySEState_BOOT
#define _UKeySEState_MAX UKeySEState_APP
#define _UKeySEState_ARRAYSIZE ((UKeySEState)(UKeySEState_APP+1))
...
#define UkeyGetFeatures_init_default             {0}
#define Features_init_default                    {false, "", 0, 0, 0, false, 0, false, "", false, "", false, "", false, 0, false, {0, {0}}, false, 0, false, "", false, 0, false, 0, false, 0, false, "", false, 0, false, "", false, "", false, 0, false, 0, false, "", false, 0, false, "", false, "", false, "", false, 0, false, "", false, _UKeyDeviceType_MIN, false, _UKeySeType_MIN, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, "", false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN}
#define UkeyFeatures_init_default                {false, _UKeyDeviceType_MIN, false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, _UKeySeType_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, "", false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, ""}
...
#define GetHardwareHash_init_default             {0}
#define HardwareHash_init_default                {{0, {0}}}
#define FactoryGetChallenge_init_default         {0}
#define FactoryChallenge_init_default            {0, {0, {0}}, {0, {0}}, 0}
#define FactoryAuthenticate_init_default         {0, 0, {0, {0}}, {0, {0}}, 0, {0, {0}}}
...
#define UkeyGetFeatures_init_zero                {0}
#define Features_init_zero                       {false, "", 0, 0, 0, false, 0, false, "", false, "", false, "", false, 0, false, {0, {0}}, false, 0, false, "", false, 0, false, 0, false, 0, false, "", false, 0, false, "", false, "", false, 0, false, 0, false, "", false, 0, false, "", false, "", false, "", false, 0, false, "", false, _UKeyDeviceType_MIN, false, _UKeySeType_MIN, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, "", false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN}
#define UkeyFeatures_init_zero                   {false, _UKeyDeviceType_MIN, false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, _UKeySeType_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, _UKeySEState_MIN, false, "", false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, ""}
...
#define GetHardwareHash_init_zero                {0}
#define HardwareHash_init_zero                   {{0, {0}}}
#define FactoryGetChallenge_init_zero            {0}
#define FactoryChallenge_init_zero               {0, {0, {0}}, {0, {0}}, 0}
#define FactoryAuthenticate_init_zero            {0, 0, {0, {0}}, {0, {0}}, 0, {0, {0}}}
...
#define FactoryAuthenticate_protocol_version_tag 1
#define FactoryAuthenticate_key_id_tag           2
#define FactoryAuthenticate_challenge_tag        3
#define FactoryAuthenticate_hardware_hash_tag    4
#define FactoryAuthenticate_init_state_tag       5
#define FactoryAuthenticate_signature_tag        6
#define FactoryChallenge_protocol_version_tag    1
#define FactoryChallenge_challenge_tag           2
#define FactoryChallenge_hardware_hash_tag       3
#define FactoryChallenge_init_state_tag          4
...
#define Features_ukey_version_tag                508
...
#define Features_ukey_device_type_tag            600
#define Features_ukey_se_type_tag                601
#define Features_ukey_board_version_tag          602
#define Features_ukey_board_hash_tag             603
#define Features_ukey_boot_version_tag           604
#define Features_ukey_boot_hash_tag              605
#define Features_ukey_se01_version_tag           606
#define Features_ukey_se01_hash_tag              607
#define Features_ukey_se01_build_id_tag          608
#define Features_ukey_firmware_version_tag       609
#define Features_ukey_firmware_hash_tag          610
#define Features_ukey_firmware_build_id_tag      611
#define Features_ukey_serial_no_tag              612
#define Features_ukey_boot_build_id_tag          613
#define Features_ukey_ble_name_tag               614
#define Features_ukey_ble_version_tag            615
#define Features_ukey_se02_version_tag           618
#define Features_ukey_se03_version_tag           619
#define Features_ukey_se04_version_tag           620
#define Features_ukey_se01_state_tag             621
#define Features_ukey_se02_state_tag             622
#define Features_ukey_se03_state_tag             623
#define Features_ukey_se04_state_tag             624
...
#define HardwareHash_hardware_hash_tag           1
...
#define UkeyFeatures_ukey_device_type_tag        1
#define UkeyFeatures_ukey_board_version_tag      2
#define UkeyFeatures_ukey_boot_version_tag       3
#define UkeyFeatures_ukey_firmware_version_tag   4
#define UkeyFeatures_ukey_board_hash_tag         5
#define UkeyFeatures_ukey_boot_hash_tag          6
#define UkeyFeatures_ukey_firmware_hash_tag      7
#define UkeyFeatures_ukey_board_build_id_tag     8
#define UkeyFeatures_ukey_boot_build_id_tag      9
#define UkeyFeatures_ukey_firmware_build_id_tag  10
#define UkeyFeatures_ukey_serial_no_tag          11
#define UkeyFeatures_ukey_ble_name_tag           12
#define UkeyFeatures_ukey_ble_version_tag        13
#define UkeyFeatures_ukey_ble_build_id_tag       14
#define UkeyFeatures_ukey_ble_hash_tag           15
#define UkeyFeatures_ukey_se_type_tag            16
#define UkeyFeatures_ukey_se01_state_tag         17
#define UkeyFeatures_ukey_se02_state_tag         18
#define UkeyFeatures_ukey_se03_state_tag         19
#define UkeyFeatures_ukey_se04_state_tag         20
#define UkeyFeatures_ukey_se01_version_tag       21
#define UkeyFeatures_ukey_se02_version_tag       22
#define UkeyFeatures_ukey_se03_version_tag       23
#define UkeyFeatures_ukey_se04_version_tag       24
#define UkeyFeatures_ukey_se01_hash_tag          25
#define UkeyFeatures_ukey_se02_hash_tag          26
#define UkeyFeatures_ukey_se03_hash_tag          27
#define UkeyFeatures_ukey_se04_hash_tag          28
#define UkeyFeatures_ukey_se01_build_id_tag      29
#define UkeyFeatures_ukey_se02_build_id_tag      30
#define UkeyFeatures_ukey_se03_build_id_tag      31
#define UkeyFeatures_ukey_se04_build_id_tag      32
#define UkeyFeatures_ukey_se01_boot_version_tag  33
#define UkeyFeatures_ukey_se02_boot_version_tag  34
#define UkeyFeatures_ukey_se03_boot_version_tag  35
#define UkeyFeatures_ukey_se04_boot_version_tag  36
#define UkeyFeatures_ukey_se01_boot_hash_tag     37
#define UkeyFeatures_ukey_se02_boot_hash_tag     38
#define UkeyFeatures_ukey_se03_boot_hash_tag     39
#define UkeyFeatures_ukey_se04_boot_hash_tag     40
#define UkeyFeatures_ukey_se01_boot_build_id_tag 41
#define UkeyFeatures_ukey_se02_boot_build_id_tag 42
#define UkeyFeatures_ukey_se03_boot_build_id_tag 43
#define UkeyFeatures_ukey_se04_boot_build_id_tag 44
...
#define UkeyGetFeatures_FIELDLIST(X, a) \

#define UkeyGetFeatures_CALLBACK NULL
#define UkeyGetFeatures_DEFAULT NULL
...
X(a, STATIC,   OPTIONAL, STRING,   ukey_version,    508) \
...
X(a, STATIC,   OPTIONAL, UENUM,    ukey_device_type, 600) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se_type,    601) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_board_version, 602) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_board_hash, 603) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_boot_version, 604) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_boot_hash,  605) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_version, 606) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se01_hash,  607) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_build_id, 608) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_firmware_version, 609) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_firmware_hash, 610) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_firmware_build_id, 611) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_serial_no,  612) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_boot_build_id, 613) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_ble_name,   614) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_ble_version, 615) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se02_version, 618) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se03_version, 619) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se04_version, 620) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se01_state, 621) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se02_state, 622) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se03_state, 623) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se04_state, 624)
#define Features_CALLBACK NULL
#define Features_DEFAULT NULL

#define UkeyFeatures_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_device_type,   1) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_board_version,   2) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_boot_version,   3) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_firmware_version,   4) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_board_hash,   5) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_boot_hash,    6) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_firmware_hash,   7) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_board_build_id,   8) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_boot_build_id,   9) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_firmware_build_id,  10) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_serial_no,   11) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_ble_name,    12) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_ble_version,  13) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_ble_build_id,  14) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_ble_hash,    15) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se_type,     16) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se01_state,  17) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se02_state,  18) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se03_state,  19) \
X(a, STATIC,   OPTIONAL, UENUM,    ukey_se04_state,  20) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_version,  21) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se02_version,  22) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se03_version,  23) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se04_version,  24) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se01_hash,   25) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se02_hash,   26) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se03_hash,   27) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se04_hash,   28) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_build_id,  29) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se02_build_id,  30) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se03_build_id,  31) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se04_build_id,  32) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_boot_version,  33) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se02_boot_version,  34) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se03_boot_version,  35) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se04_boot_version,  36) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se01_boot_hash,  37) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se02_boot_hash,  38) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se03_boot_hash,  39) \
X(a, STATIC,   OPTIONAL, BYTES,    ukey_se04_boot_hash,  40) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se01_boot_build_id,  41) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se02_boot_build_id,  42) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se03_boot_build_id,  43) \
X(a, STATIC,   OPTIONAL, STRING,   ukey_se04_boot_build_id,  44)
#define UkeyFeatures_CALLBACK NULL
#define UkeyFeatures_DEFAULT NULL
...
#define GetHardwareHash_FIELDLIST(X, a) \

#define GetHardwareHash_CALLBACK NULL
#define GetHardwareHash_DEFAULT NULL

#define HardwareHash_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, BYTES,    hardware_hash,     1)
#define HardwareHash_CALLBACK NULL
#define HardwareHash_DEFAULT NULL

#define FactoryGetChallenge_FIELDLIST(X, a) \

#define FactoryGetChallenge_CALLBACK NULL
#define FactoryGetChallenge_DEFAULT NULL

#define FactoryChallenge_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, UINT32,   protocol_version,   1) \
X(a, STATIC,   REQUIRED, BYTES,    challenge,         2) \
X(a, STATIC,   REQUIRED, BYTES,    hardware_hash,     3) \
X(a, STATIC,   REQUIRED, UINT32,   init_state,        4)
#define FactoryChallenge_CALLBACK NULL
#define FactoryChallenge_DEFAULT NULL

#define FactoryAuthenticate_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, UINT32,   protocol_version,   1) \
X(a, STATIC,   REQUIRED, UINT32,   key_id,            2) \
X(a, STATIC,   REQUIRED, BYTES,    challenge,         3) \
X(a, STATIC,   REQUIRED, BYTES,    hardware_hash,     4) \
X(a, STATIC,   REQUIRED, UINT32,   init_state,        5) \
X(a, STATIC,   REQUIRED, BYTES,    signature,         6)
#define FactoryAuthenticate_CALLBACK NULL
#define FactoryAuthenticate_DEFAULT NULL
...
extern const pb_msgdesc_t UkeyGetFeatures_msg;
extern const pb_msgdesc_t Features_msg;
extern const pb_msgdesc_t UkeyFeatures_msg;
...
extern const pb_msgdesc_t GetHardwareHash_msg;
extern const pb_msgdesc_t HardwareHash_msg;
extern const pb_msgdesc_t FactoryGetChallenge_msg;
extern const pb_msgdesc_t FactoryChallenge_msg;
extern const pb_msgdesc_t FactoryAuthenticate_msg;
...
#define UkeyGetFeatures_fields &UkeyGetFeatures_msg
#define Features_fields &Features_msg
#define UkeyFeatures_fields &UkeyFeatures_msg
...
#define GetHardwareHash_fields &GetHardwareHash_msg
#define HardwareHash_fields &HardwareHash_msg
#define FactoryGetChallenge_fields &FactoryGetChallenge_msg
#define FactoryChallenge_fields &FactoryChallenge_msg
#define FactoryAuthenticate_fields &FactoryAuthenticate_msg
...
#define FactoryAuthenticate_size                 152
#define FactoryChallenge_size                    80
#define FactoryGetChallenge_size                 0
...
#define GetHardwareHash_size                     0
#define HardwareHash_size                        34
...
#define UkeyFeatures_size                        899
#define UkeyGetFeatures_size                     0
