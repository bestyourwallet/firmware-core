...
from trezor.lvglui.scrs import lv_theme
                ...
                if usertype == PinResult.PASSPHRASE_PIN_ENTERED:
                    ...
                    if result == PIN_CANCEL:
                        ...
                        (
                            remove_result,
                            is_current,
                        ) = se_acl16.delete_pin_passphrase(passphrase_pin_str)
            # write into storage
            ...
            if newpin:
                ...
                if usertype == PinResult.PASSPHRASE_PIN_ENTERED:
                    ...
                    if result == PIN_CANCEL:
                        ...
                        result = se_acl16.change_pin_passphrase(curpin, newpin)
