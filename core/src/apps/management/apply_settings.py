...
from trezor.lvglui.scrs import lv_theme, theme_path_default
...
async def apply_settings(ctx: wire.Context, msg: ApplySettings) -> Success:
    ...
    if msg.homescreen is not None:
        ...
        storage.device.set_homescreen(
            theme_path_default(msg.homescreen.decode() + ".png")
        )
    ...
    if msg.use_passphrase is not None:
        ...
        if not msg.use_passphrase and storage.device.is_passphrase_pin_enabled():
