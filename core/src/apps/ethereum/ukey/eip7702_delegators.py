...
from trezor.lvglui.scrs import theme_path, theme_path_default
...
def _get_delegator_provider_icon(delegator_name: str) -> str:
    if delegator_name == "OKX":
        return theme_path_default("chain_provider-okx.png")
    elif delegator_name == "MetaMask":
        return theme_path_default("sys_icon_mm-logo-96.png")
    elif delegator_name in ("Revoke", "Simple7702"):
        return theme_path("send.png")
    return theme_path("send.png")
