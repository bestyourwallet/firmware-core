...
if TYPE_CHECKING:
    ...
    from trezor.messages import (
        EthereumGetAddressUKey as EthereumGetAddress,
        EthereumGetPublicKeyUKey as EthereumGetPublicKey,
        EthereumSignMessageUKey as EthereumSignMessage,
        EthereumSignTxUKey as EthereumSignTx,
        EthereumSignTxEIP1559UKey as EthereumSignTxEIP1559,
        EthereumSignTypedDataUKey as EthereumSignTypedData,
        EthereumSignTypedHashUKey as EthereumSignTypedHash,
        EthereumSignTxEIP7702UKey as EthereumSignTxEIP7702,
    )
    ...
    EthereumMessages = (
        ...
        | EthereumSignTxEIP7702
    )
    MsgIn = TypeVar("MsgIn", bound=EthereumMessages)

    EthereumSignTxAny = EthereumSignTx | EthereumSignTxEIP1559 | EthereumSignTxEIP7702
