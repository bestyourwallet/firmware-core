...
PROVIDER_META = {
    "1inch": theme_path_default("chain_provider-1inch.png"),
    "OKX": theme_path_default("chain_provider-okx.png"),
    "0x": theme_path_default("chain_provider-0x.png"),
    "CoW": theme_path_default("chain_provider-cowswap.png"),
    "Socket": theme_path_default("chain_provider-socket.png"),
}
