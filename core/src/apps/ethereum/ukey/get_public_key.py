...
from trezor.messages import EthereumPublicKeyUKey as EthereumPublicKey, HDNodeType
...
if TYPE_CHECKING:
    from trezor.messages import EthereumGetPublicKeyUKey as EthereumGetPublicKey
