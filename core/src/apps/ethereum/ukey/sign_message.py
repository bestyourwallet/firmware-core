...
from trezor.messages import EthereumMessageSignatureUKey as EthereumMessageSignature
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignMessageUKey as EthereumSignMessage
