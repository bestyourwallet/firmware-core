...
trezor.enums.UKeyDeviceType
import trezor.enums.UKeyDeviceType
trezor.enums.UKeySEState
import trezor.enums.UKeySEState
trezor.enums.UKeySeType
import trezor.enums.UKeySeType
...
trezor.lvglui.lv_theme
import trezor.lvglui.lv_theme
trezor.lvglui.lv_theme.dark
import trezor.lvglui.lv_theme.dark
trezor.lvglui.lv_theme.light
import trezor.lvglui.lv_theme.light
trezor.lvglui.scrs
...
trezor.lvglui.scrs.components.line
import trezor.lvglui.scrs.components.line
...
apps.aptos.tokens
import apps.aptos.tokens
apps.aptos.transaction
import apps.aptos.transaction
apps.base
import apps.base
apps.bitcoin
import apps.bitcoin
...
apps.management.serial_codec
import apps.management.serial_codec
...
apps.sui.transaction
import apps.sui.transaction
apps.ton
import apps.ton
...
if not utils.BITCOIN_ONLY:
    ...
    trezor.enums.EthereumDataTypeUKey
    import trezor.enums.EthereumDataTypeUKey
    ...
    apps.ethereum.ukey.eip7702_delegators
    import apps.ethereum.ukey.eip7702_delegators
    apps.ethereum.ukey.get_address
    import apps.ethereum.ukey.get_address
    apps.ethereum.ukey.get_public_key
    import apps.ethereum.ukey.get_public_key
    apps.ethereum.ukey.keychain
    import apps.ethereum.ukey.keychain
    apps.ethereum.ukey.providers
    import apps.ethereum.ukey.providers
    apps.ethereum.ukey.sign_message
    import apps.ethereum.ukey.sign_message
    apps.ethereum.ukey.sign_safe_tx
    import apps.ethereum.ukey.sign_safe_tx
    apps.ethereum.ukey.sign_tx
    import apps.ethereum.ukey.sign_tx
    apps.ethereum.ukey.sign_tx_eip1559
    import apps.ethereum.ukey.sign_tx_eip1559
    apps.ethereum.ukey.sign_tx_eip7702
    import apps.ethereum.ukey.sign_tx_eip7702
    apps.ethereum.ukey.sign_typed_data
    import apps.ethereum.ukey.sign_typed_data
    apps.ethereum.ukey.sign_typed_data_hash
    import apps.ethereum.ukey.sign_typed_data_hash
    apps.ethereum.ukey.verify_message
    import apps.ethereum.ukey.verify_message
