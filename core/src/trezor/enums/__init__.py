...
if TYPE_CHECKING:
    ...
    class MessageType(IntEnum):
        ...
        EmmcDirMake = 30109
        EmmcDirRemove = 30110
        GetHardwareHash = 30111
        HardwareHash = 30112
        FactoryGetChallenge = 30113
        FactoryChallenge = 30114
        FactoryAuthenticate = 30115
        ...
        EthereumGetPublicKeyUKey = 20100
        EthereumPublicKeyUKey = 20101
        EthereumGetAddressUKey = 20102
        EthereumAddressUKey = 20103
        EthereumSignTxUKey = 20104
        EthereumSignTxEIP1559UKey = 20105
        EthereumTxRequestUKey = 20106
        EthereumTxAckUKey = 20107
        EthereumSignMessageUKey = 20108
        EthereumVerifyMessageUKey = 20109
        EthereumMessageSignatureUKey = 20110
        EthereumSignTypedDataUKey = 20111
        EthereumTypedDataStructRequestUKey = 20112
        EthereumTypedDataStructAckUKey = 20113
        EthereumTypedDataValueRequestUKey = 20114
        EthereumTypedDataValueAckUKey = 20115
        EthereumTypedDataSignatureUKey = 20116
        EthereumSignTypedHashUKey = 20117
        EthereumGnosisSafeTxAck = 20118
        EthereumGnosisSafeTxRequest = 20119
        EthereumSignTxEIP7702UKey = 20120
        NEMGetAddress = 67
        NEMAddress = 68
        NEMSignTx = 69
        NEMSignedTx = 70
    ...
    class UKeySeType(IntEnum):
        ACL16 = 0
        SE608A = 1

    class UKeySEState(IntEnum):
        BOOT = 0
        APP = 1
    ...
    class EthereumDataTypeUKey(IntEnum):
        UINT = 1
        INT = 2
        BYTES = 3
        STRING = 4
