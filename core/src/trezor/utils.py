...
BACKUP_METHOD_RING = const(2)
BACKUP_METHOD_SEED_TI = const(3)
...
def set_backup_ring():
    global _CURRENT_BACKUP_METHOD
    _CURRENT_BACKUP_METHOD = BACKUP_METHOD_RING


def set_backup_seed_ti():
    global _CURRENT_BACKUP_METHOD
    _CURRENT_BACKUP_METHOD = BACKUP_METHOD_SEED_TI
