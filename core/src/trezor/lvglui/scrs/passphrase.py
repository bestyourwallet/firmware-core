...
from . import font_GeistRegular30, lv_theme
...
class PassphraseRequest(FullSizeWindow):
    def __init__(self, max_len: int, result: str | None = None, min_len: int = 0):
        ...
        self.keyboard = PassphraseKeyboard(self, max_len, min_len)
