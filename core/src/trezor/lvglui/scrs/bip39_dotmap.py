...
from . import lv, lv_theme, theme_path_default
...
class Bip39DotMap(FullSizeWindow):
    def __init__(self, word_count: int) -> None:
        ...
        self.panel.add_style(
            ...
            .radius(0)
            .pad_all(0)
            .bg_img_src(theme_path_default("default_prompt_dotmap-front.png"))
        ...
        self.btn_yes.align_to(self.tips_bar, lv.ALIGN.OUT_BOTTOM_MID, 0, 15)
        self.add_style(StyleWrapper().pad_bottom(15), 0)
    ...
    def show_back(self):
        ...
        self.btn_yes.enable(lv_theme.APP_CORRECT_BG, text_color=lv_theme.BTN_YES_BG)
        ...
        self.panel.set_style_bg_img_src(
            theme_path_default("default_prompt_dotmap-back.png"), 0
        )
        self.matrix.clean()
        for i in range(12):
            index = self.BinaryWordIndex(self.matrix)
    ...
    class BinaryWordIndex(lv.obj):
        def __init__(self, parent) -> None:
            ...
            self.point_style = (
                ...
                .width(16)
                .height(16)
                .bg_color(lv_theme.DOT_POINT_BG)
                .border_width(0)
        ...
        class Point(lv.obj):
            ...
            def set_checked(self):
                self.checked = True
                self.set_style_bg_color(lv_theme.DOT_POINT_PBG, 0)

            def set_uncheck(self):
                self.checked = False
                self.set_style_bg_color(lv_theme.DOT_POINT_BG, 0)
