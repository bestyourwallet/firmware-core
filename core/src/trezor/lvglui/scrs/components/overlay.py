from .. import font_GeistRegular26, lv, lv_theme
...
class OverlayWithProcessBar(Overlay):
    def __init__(self, parent, max_value: int, value: int = 0):
        ...
        self.process_bar.add_style(
            StyleWrapper()
            .bg_color(lv_theme.OVERLAY_PROGRESS_BG)
            .bg_opa(lv.OPA.COVER)
            .radius(40),
            0,
        )
        self.process_bar.add_style(
            StyleWrapper().bg_color(lv_theme.OVERLAY_PROGRESS_FG),
        ...
        self.precess_value.add_style(
            ...
            .text_color(lv_theme.OVERLAY_PROGRESS_FG),
            0,
        )
...
#         self.fake_bg.set_src(theme_path_default("scan-success-overlay.png"))
...
#         self.scan_loading.set_src(theme_path_default("scan-success-loading.png"))
