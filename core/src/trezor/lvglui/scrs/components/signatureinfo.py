...
from .. import font_GeistMono28, font_GeistSemiBold26, lv, lv_theme, theme_path_png
...
class DirectionComponent:
    ...
    def __init__(
        ...
        self.icon = icon or theme_path_png("group-icon-directions")
...
class AmountComponent:
    ...
    def __init__(
        ...
        self.icon = icon or theme_path_png("group-icon-amount")
...
class FeeComponent:
    ...
    def __init__(
        ...
        self.icon = icon or theme_path_png("group-icon-fees")
...
class MoreInfoComponent:
    ...
    def __init__(
        ...
        self.icon = icon or theme_path_png("group-icon-more")
...
class DataComponent:
    ...
    def __init__(
        ...
        self.icon = icon or theme_path_png("group-icon-data")
        self.max_length = max_length
        self.primary_color = primary_color or lv_theme.APP_CORRECT_BG
