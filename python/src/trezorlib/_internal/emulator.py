...
class Emulator:
    ...
    def __init__(
        ...
        *,
        ...
        if logfile:
            ...
            self.logfile = self.profile_dir / "ukey.log"
    ...
    def start(self) -> None:
        ...
        (self.profile_dir / "ukey.pid").write_text(str(self.process.pid) + "\n")
        (self.profile_dir / "ukey.port").write_text(str(self.port) + "\n")
    ...
    def stop(self) -> None:
        ...
        _rm_f(self.profile_dir / "ukey.pid")
        _rm_f(self.profile_dir / "ukey.port")
        self.process = None
...
class CoreEmulator(Emulator):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.sdcard = self.profile_dir / "ukey.sdcard"
