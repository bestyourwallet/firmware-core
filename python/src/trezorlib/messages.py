...
class SignMessage(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        10: protobuf.Field("is_bip322_simple", "bool", repeated=False, required=False),
    }
...
class GetHardwareHash(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 30111


class HardwareHash(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 30112
    FIELDS = {
        1: protobuf.Field("hardware_hash", "bytes", repeated=False, required=True),
    }
...
class CardanoGetAddress(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        7: protobuf.Field("chunkify", "bool", repeated=False, required=False),
    }
...
class CardanoSignTxInit(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        22: protobuf.Field("chunkify", "bool", repeated=False, required=False),
        23: protobuf.Field("tag_cbor_sets", "bool", repeated=False, required=False),
    }
...
class CardanoDRep(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        2: protobuf.Field("key_hash", "bytes", repeated=False, required=False),
...
class CardanoTxCertificate(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        7: protobuf.Field("deposit", "uint64", repeated=False, required=False),
        8: protobuf.Field("drep", "CardanoDRep", repeated=False, required=False),
    }
...
class UkeyGetFeatures(protobuf.MessageType):
...
class Features(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        508: protobuf.Field("ukey_version", "string", repeated=False, required=False),
        509: protobuf.Field("ukey_serial", "string", repeated=False, required=False),
        ...
        600: protobuf.Field("ukey_device_type", "UKeyDeviceType", repeated=False, required=False),
        601: protobuf.Field("ukey_se_type", "UKeySeType", repeated=False, required=False),
        602: protobuf.Field("ukey_board_version", "string", repeated=False, required=False),
        603: protobuf.Field("ukey_board_hash", "bytes", repeated=False, required=False),
        604: protobuf.Field("ukey_boot_version", "string", repeated=False, required=False),
        605: protobuf.Field("ukey_boot_hash", "bytes", repeated=False, required=False),
        606: protobuf.Field("ukey_se01_version", "string", repeated=False, required=False),
        607: protobuf.Field("ukey_se01_hash", "bytes", repeated=False, required=False),
        608: protobuf.Field("ukey_se01_build_id", "string", repeated=False, required=False),
        609: protobuf.Field("ukey_firmware_version", "string", repeated=False, required=False),
        610: protobuf.Field("ukey_firmware_hash", "bytes", repeated=False, required=False),
        611: protobuf.Field("ukey_firmware_build_id", "string", repeated=False, required=False),
        612: protobuf.Field("ukey_serial_no", "string", repeated=False, required=False),
        613: protobuf.Field("ukey_boot_build_id", "string", repeated=False, required=False),
        614: protobuf.Field("ukey_ble_name", "string", repeated=False, required=False),
        615: protobuf.Field("ukey_ble_version", "string", repeated=False, required=False),
        616: protobuf.Field("ukey_ble_build_id", "string", repeated=False, required=False),
        617: protobuf.Field("ukey_ble_hash", "bytes", repeated=False, required=False),
        618: protobuf.Field("ukey_se02_version", "string", repeated=False, required=False),
        619: protobuf.Field("ukey_se03_version", "string", repeated=False, required=False),
        620: protobuf.Field("ukey_se04_version", "string", repeated=False, required=False),
        621: protobuf.Field("ukey_se01_state", "UKeySEState", repeated=False, required=False),
        622: protobuf.Field("ukey_se02_state", "UKeySEState", repeated=False, required=False),
        623: protobuf.Field("ukey_se03_state", "UKeySEState", repeated=False, required=False),
        624: protobuf.Field("ukey_se04_state", "UKeySEState", repeated=False, required=False),
    ...
    def __init__(
        ...
        *,
        ...
        ukey_version: Optional["str"] = None,
        ukey_serial: Optional["str"] = None,
        ...
        ukey_device_type: Optional["UKeyDeviceType"] = None,
        ukey_se_type: Optional["UKeySeType"] = None,
        ukey_board_version: Optional["str"] = None,
        ukey_board_hash: Optional["bytes"] = None,
        ukey_boot_version: Optional["str"] = None,
        ukey_boot_hash: Optional["bytes"] = None,
        ukey_se01_version: Optional["str"] = None,
        ukey_se01_hash: Optional["bytes"] = None,
        ukey_se01_build_id: Optional["str"] = None,
        ukey_firmware_version: Optional["str"] = None,
        ukey_firmware_hash: Optional["bytes"] = None,
        ukey_firmware_build_id: Optional["str"] = None,
        ukey_serial_no: Optional["str"] = None,
        ukey_boot_build_id: Optional["str"] = None,
        ukey_ble_name: Optional["str"] = None,
        ukey_ble_version: Optional["str"] = None,
        ukey_ble_build_id: Optional["str"] = None,
        ukey_ble_hash: Optional["bytes"] = None,
        ukey_se02_version: Optional["str"] = None,
        ukey_se03_version: Optional["str"] = None,
        ukey_se04_version: Optional["str"] = None,
        ukey_se01_state: Optional["UKeySEState"] = None,
        ukey_se02_state: Optional["UKeySEState"] = None,
        ukey_se03_state: Optional["UKeySEState"] = None,
        ukey_se04_state: Optional["UKeySEState"] = None,
        ...
        self.ukey_version = ukey_version
        self.ukey_serial = ukey_serial
        ...
        self.busy = busy
        self.ukey_device_type = ukey_device_type
        self.ukey_se_type = ukey_se_type
        self.ukey_board_version = ukey_board_version
        self.ukey_board_hash = ukey_board_hash
        self.ukey_boot_version = ukey_boot_version
        self.ukey_boot_hash = ukey_boot_hash
        self.ukey_se01_version = ukey_se01_version
        self.ukey_se01_hash = ukey_se01_hash
        self.ukey_se01_build_id = ukey_se01_build_id
        self.ukey_firmware_version = ukey_firmware_version
        self.ukey_firmware_hash = ukey_firmware_hash
        self.ukey_firmware_build_id = ukey_firmware_build_id
        self.ukey_serial_no = ukey_serial_no
        self.ukey_boot_build_id = ukey_boot_build_id
        self.ukey_ble_name = ukey_ble_name
        self.ukey_ble_version = ukey_ble_version
        self.ukey_ble_build_id = ukey_ble_build_id
        self.ukey_ble_hash = ukey_ble_hash
        self.ukey_se02_version = ukey_se02_version
        self.ukey_se03_version = ukey_se03_version
        self.ukey_se04_version = ukey_se04_version
        self.ukey_se01_state = ukey_se01_state
        self.ukey_se02_state = ukey_se02_state
        self.ukey_se03_state = ukey_se03_state
        self.ukey_se04_state = ukey_se04_state
        self.attach_to_pin_user = attach_to_pin_user
        self.unlocked_attach_pin = unlocked_attach_pin


class UkeyFeatures(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 10026
    FIELDS = {
        1: protobuf.Field("ukey_device_type", "UKeyDeviceType", repeated=False, required=False),
        2: protobuf.Field("ukey_board_version", "string", repeated=False, required=False),
        3: protobuf.Field("ukey_boot_version", "string", repeated=False, required=False),
        4: protobuf.Field("ukey_firmware_version", "string", repeated=False, required=False),
        5: protobuf.Field("ukey_board_hash", "bytes", repeated=False, required=False),
        6: protobuf.Field("ukey_boot_hash", "bytes", repeated=False, required=False),
        7: protobuf.Field("ukey_firmware_hash", "bytes", repeated=False, required=False),
        8: protobuf.Field("ukey_board_build_id", "string", repeated=False, required=False),
        9: protobuf.Field("ukey_boot_build_id", "string", repeated=False, required=False),
        10: protobuf.Field("ukey_firmware_build_id", "string", repeated=False, required=False),
        11: protobuf.Field("ukey_serial_no", "string", repeated=False, required=False),
        12: protobuf.Field("ukey_ble_name", "string", repeated=False, required=False),
        13: protobuf.Field("ukey_ble_version", "string", repeated=False, required=False),
        14: protobuf.Field("ukey_ble_build_id", "string", repeated=False, required=False),
        15: protobuf.Field("ukey_ble_hash", "bytes", repeated=False, required=False),
        16: protobuf.Field("ukey_se_type", "UKeySeType", repeated=False, required=False),
        17: protobuf.Field("ukey_se01_state", "UKeySEState", repeated=False, required=False),
        18: protobuf.Field("ukey_se02_state", "UKeySEState", repeated=False, required=False),
        19: protobuf.Field("ukey_se03_state", "UKeySEState", repeated=False, required=False),
        20: protobuf.Field("ukey_se04_state", "UKeySEState", repeated=False, required=False),
        21: protobuf.Field("ukey_se01_version", "string", repeated=False, required=False),
        22: protobuf.Field("ukey_se02_version", "string", repeated=False, required=False),
        23: protobuf.Field("ukey_se03_version", "string", repeated=False, required=False),
        24: protobuf.Field("ukey_se04_version", "string", repeated=False, required=False),
        25: protobuf.Field("ukey_se01_hash", "bytes", repeated=False, required=False),
        26: protobuf.Field("ukey_se02_hash", "bytes", repeated=False, required=False),
        27: protobuf.Field("ukey_se03_hash", "bytes", repeated=False, required=False),
        28: protobuf.Field("ukey_se04_hash", "bytes", repeated=False, required=False),
        29: protobuf.Field("ukey_se01_build_id", "string", repeated=False, required=False),
        30: protobuf.Field("ukey_se02_build_id", "string", repeated=False, required=False),
        31: protobuf.Field("ukey_se03_build_id", "string", repeated=False, required=False),
        32: protobuf.Field("ukey_se04_build_id", "string", repeated=False, required=False),
        33: protobuf.Field("ukey_se01_boot_version", "string", repeated=False, required=False),
        34: protobuf.Field("ukey_se02_boot_version", "string", repeated=False, required=False),
        35: protobuf.Field("ukey_se03_boot_version", "string", repeated=False, required=False),
        36: protobuf.Field("ukey_se04_boot_version", "string", repeated=False, required=False),
        37: protobuf.Field("ukey_se01_boot_hash", "bytes", repeated=False, required=False),
        38: protobuf.Field("ukey_se02_boot_hash", "bytes", repeated=False, required=False),
        39: protobuf.Field("ukey_se03_boot_hash", "bytes", repeated=False, required=False),
        40: protobuf.Field("ukey_se04_boot_hash", "bytes", repeated=False, required=False),
        41: protobuf.Field("ukey_se01_boot_build_id", "string", repeated=False, required=False),
        42: protobuf.Field("ukey_se02_boot_build_id", "string", repeated=False, required=False),
        43: protobuf.Field("ukey_se03_boot_build_id", "string", repeated=False, required=False),
        44: protobuf.Field("ukey_se04_boot_build_id", "string", repeated=False, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        ukey_boot_hash: Optional["bytes"] = None,
        ukey_firmware_hash: Optional["bytes"] = None,
        ukey_board_build_id: Optional["str"] = None,
        ukey_boot_build_id: Optional["str"] = None,
        ukey_firmware_build_id: Optional["str"] = None,
        ukey_serial_no: Optional["str"] = None,
        ukey_ble_name: Optional["str"] = None,
        ...
        ukey_se04_version: Optional["str"] = None,
        ukey_se01_hash: Optional["bytes"] = None,
        ukey_se02_hash: Optional["bytes"] = None,
        ukey_se03_hash: Optional["bytes"] = None,
        ukey_se04_hash: Optional["bytes"] = None,
        ukey_se01_build_id: Optional["str"] = None,
        ukey_se02_build_id: Optional["str"] = None,
        ukey_se03_build_id: Optional["str"] = None,
        ukey_se04_build_id: Optional["str"] = None,
        ukey_se01_boot_version: Optional["str"] = None,
        ukey_se02_boot_version: Optional["str"] = None,
        ukey_se03_boot_version: Optional["str"] = None,
        ukey_se04_boot_version: Optional["str"] = None,
        ukey_se01_boot_hash: Optional["bytes"] = None,
        ukey_se02_boot_hash: Optional["bytes"] = None,
        ukey_se03_boot_hash: Optional["bytes"] = None,
        ukey_se04_boot_hash: Optional["bytes"] = None,
        ukey_se01_boot_build_id: Optional["str"] = None,
        ukey_se02_boot_build_id: Optional["str"] = None,
        ukey_se03_boot_build_id: Optional["str"] = None,
        ukey_se04_boot_build_id: Optional["str"] = None,
    ) -> None:
        self.ukey_device_type = ukey_device_type
        self.ukey_board_version = ukey_board_version
        self.ukey_boot_version = ukey_boot_version
        ...
        self.ukey_boot_hash = ukey_boot_hash
        self.ukey_firmware_hash = ukey_firmware_hash
        self.ukey_board_build_id = ukey_board_build_id
        self.ukey_boot_build_id = ukey_boot_build_id
        self.ukey_firmware_build_id = ukey_firmware_build_id
        self.ukey_serial_no = ukey_serial_no
        self.ukey_ble_name = ukey_ble_name
        ...
        self.ukey_se04_version = ukey_se04_version
        self.ukey_se01_hash = ukey_se01_hash
        self.ukey_se02_hash = ukey_se02_hash
        self.ukey_se03_hash = ukey_se03_hash
        self.ukey_se04_hash = ukey_se04_hash
        self.ukey_se01_build_id = ukey_se01_build_id
        self.ukey_se02_build_id = ukey_se02_build_id
        self.ukey_se03_build_id = ukey_se03_build_id
        self.ukey_se04_build_id = ukey_se04_build_id
        self.ukey_se01_boot_version = ukey_se01_boot_version
        self.ukey_se02_boot_version = ukey_se02_boot_version
        self.ukey_se03_boot_version = ukey_se03_boot_version
        self.ukey_se04_boot_version = ukey_se04_boot_version
        self.ukey_se01_boot_hash = ukey_se01_boot_hash
        self.ukey_se02_boot_hash = ukey_se02_boot_hash
        self.ukey_se03_boot_hash = ukey_se03_boot_hash
        self.ukey_se04_boot_hash = ukey_se04_boot_hash
        self.ukey_se01_boot_build_id = ukey_se01_boot_build_id
        self.ukey_se02_boot_build_id = ukey_se02_boot_build_id
        self.ukey_se03_boot_build_id = ukey_se03_boot_build_id
        self.ukey_se04_boot_build_id = ukey_se04_boot_build_id
...
class FactoryGetChallenge(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 30113


class FactoryChallenge(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 30114
    FIELDS = {
        1: protobuf.Field("protocol_version", "uint32", repeated=False, required=True),
        2: protobuf.Field("challenge", "bytes", repeated=False, required=True),
        3: protobuf.Field("hardware_hash", "bytes", repeated=False, required=True),
        4: protobuf.Field("init_state", "uint32", repeated=False, required=True),
    }
...
class FactoryAuthenticate(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 30115
    FIELDS = {
        1: protobuf.Field("protocol_version", "uint32", repeated=False, required=True),
        2: protobuf.Field("key_id", "uint32", repeated=False, required=True),
        3: protobuf.Field("challenge", "bytes", repeated=False, required=True),
        4: protobuf.Field("hardware_hash", "bytes", repeated=False, required=True),
        5: protobuf.Field("init_state", "uint32", repeated=False, required=True),
        6: protobuf.Field("signature", "bytes", repeated=False, required=True),
    }
...
class EthereumSignTypedDataUKey(protobuf.MessageType):
...
class EthereumTypedDataStructRequestUKey(protobuf.MessageType):
...
class EthereumTypedDataStructAckUKey(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 20113
    FIELDS = {
        1: protobuf.Field("members", "EthereumStructMemberUKey", repeated=True, required=False),
    }

    def __init__(
        self,
        *,
        members: Optional[Sequence["EthereumStructMemberUKey"]] = None,
    ) -> None:
        self.members: Sequence["EthereumStructMemberUKey"] = members if members is not None else []


class EthereumTypedDataValueRequestUKey(protobuf.MessageType):
...
class EthereumTypedDataValueAckUKey(protobuf.MessageType):
...
class EthereumGnosisSafeTxAck(protobuf.MessageType):
    ...
    FIELDS = {
        1: protobuf.Field("to", "string", repeated=False, required=True),
        2: protobuf.Field("value", "bytes", repeated=False, required=True),
        3: protobuf.Field("data", "bytes", repeated=False, required=False),
        4: protobuf.Field("operation", "EthereumGnosisSafeTxOperation", repeated=False, required=True),
        5: protobuf.Field("safeTxGas", "bytes", repeated=False, required=True),
        6: protobuf.Field("baseGas", "bytes", repeated=False, required=True),
        7: protobuf.Field("gasPrice", "bytes", repeated=False, required=True),
        8: protobuf.Field("gasToken", "string", repeated=False, required=True),
        9: protobuf.Field("refundReceiver", "string", repeated=False, required=True),
        10: protobuf.Field("nonce", "bytes", repeated=False, required=True),
        11: protobuf.Field("chain_id", "uint64", repeated=False, required=True),
        12: protobuf.Field("verifyingContract", "string", repeated=False, required=True),
    }
...
class EthereumStructMemberUKey(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("type", "EthereumFieldTypeUKey", repeated=False, required=True),
...
class EthereumFieldTypeUKey(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("data_type", "EthereumDataTypeUKey", repeated=False, required=True),
        2: protobuf.Field("size", "uint32", repeated=False, required=False),
        3: protobuf.Field("entry_type", "EthereumFieldTypeUKey", repeated=False, required=False),
    ...
    def __init__(
        ...
        *,
        ...
        entry_type: Optional["EthereumFieldTypeUKey"] = None,
...
class EthereumGetPublicKeyUKey(protobuf.MessageType):
...
class EthereumPublicKeyUKey(protobuf.MessageType):
...
class EthereumGetAddressUKey(protobuf.MessageType):
...
class EthereumAddressUKey(protobuf.MessageType):
...
class EthereumSignTxUKey(protobuf.MessageType):
...
class EthereumAccessListUKey(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("address", "string", repeated=False, required=True),
...
class EthereumSignTxEIP1559UKey(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        11: protobuf.Field("access_list", "EthereumAccessListUKey", repeated=True, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        chain_id: "int",
        address_n: Optional[Sequence["int"]] = None,
        access_list: Optional[Sequence["EthereumAccessListUKey"]] = None,
        to: Optional["str"] = '',
        data_initial_chunk: Optional["bytes"] = b'',
    ) -> None:
        self.address_n: Sequence["int"] = address_n if address_n is not None else []
        self.access_list: Sequence["EthereumAccessListUKey"] = access_list if access_list is not None else []
        self.nonce = nonce
...
class EthereumSignTxEIP7702UKey(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        10: protobuf.Field("chain_id", "uint64", repeated=False, required=True),
        11: protobuf.Field("access_list", "EthereumAccessListUKey", repeated=True, required=False),
        12: protobuf.Field("authorization_list", "EthereumAuthorizationUKey", repeated=True, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        address_n: Optional[Sequence["int"]] = None,
        access_list: Optional[Sequence["EthereumAccessListUKey"]] = None,
        authorization_list: Optional[Sequence["EthereumAuthorizationUKey"]] = None,
        data_initial_chunk: Optional["bytes"] = b'',
    ) -> None:
        self.address_n: Sequence["int"] = address_n if address_n is not None else []
        self.access_list: Sequence["EthereumAccessListUKey"] = access_list if access_list is not None else []
        self.authorization_list: Sequence["EthereumAuthorizationUKey"] = authorization_list if authorization_list is not None else []
        self.nonce = nonce
        self.max_gas_fee = max_gas_fee
        self.max_priority_fee = max_priority_fee
        self.gas_limit = gas_limit
...
class EthereumTxRequestUKey(protobuf.MessageType):
...
class EthereumTxAckUKey(protobuf.MessageType):
...
class EthereumSignMessageUKey(protobuf.MessageType):
...
class EthereumMessageSignatureUKey(protobuf.MessageType):
...
class EthereumVerifyMessageUKey(protobuf.MessageType):
...
class EthereumSignTypedHashUKey(protobuf.MessageType):
...
class EthereumTypedDataSignatureUKey(protobuf.MessageType):
...
class EthereumAuthorizationUKey(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("address_n", "uint32", repeated=True, required=False),
        2: protobuf.Field("chain_id", "uint64", repeated=False, required=True),
...
class LnurlAuthResp(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        2: protobuf.Field("path", "string", repeated=False, required=False),
        3: protobuf.Field("signature", "bytes", repeated=False, required=False),
    }
...
class TonSignProof(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        3: protobuf.Field("comment", "bytes", repeated=False, required=False),
        4: protobuf.Field("expire_at", "uint64", repeated=False, required=True),
        5: protobuf.Field("wallet_version", "TonWalletVersion", repeated=False, required=False),
        6: protobuf.Field("wallet_id", "uint32", repeated=False, required=False),
        7: protobuf.Field("workchain", "TonWorkChain", repeated=False, required=False),
        8: protobuf.Field("is_bounceable", "bool", repeated=False, required=False),
        9: protobuf.Field("is_testnet_only", "bool", repeated=False, required=False),
    }
