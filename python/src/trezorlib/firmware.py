...
V2_BOARDLOADER_KEYS = [
    bytes.fromhex(key)
    for key in (
        "f70f2f846154835212d67cf1f793415188fc28aad6da9ed5cc9cfc02945dc76f",
        "dbbca5c4b72b38404773e3cc51d1b949a72e2ffbe0e25633bf4f639417357834",
        "cbff856acdefdf12485308291f94df1d3a2123a6df6ab23318299baf9058293c",
        "10e45de99afb2faec95107d4dff035573c9c46637542bee6f1a5bb0fd2215066",
        "8c299e213f85fe1a23374d8b6ab3b07d58a56640e6d90a3d8af79de9dbcf3a3e",
        "6786543761361dc48636a18a89c9a3f9fbd4752d7f4832ba2caa66e965b21ef9",
        "441db39f1ec9e957590a562360f9d264911c1f617c7162b26bc585186deeddf9"
    )
]
...
V2_BOARDLOADER_DEV_KEYS = [
    bytes.fromhex(key)
    for key in (
        "3452fee5f0454b1911ea86949f92f9ee5699fda21e2c989e84a5822110971276",
        "96e9e1fa167e84778dc1ff1ac0ef630a90bef4f2e2f59cd558a3fbf4634afa74",
        "f5eca3c84711e55644c249b20c70bdabfe31c52b90d02c57cbb757e52106f2a3",
    )
]
...
V2_DEV_SIGS_REQUIRED = 2
V2_PROD_SIGS_REQUIRED = 4
V2_SIGS_REQUIRED = V2_PROD_SIGS_REQUIRED
        ...
        try:
            try:
                ...
                cosi.verify(
                    fw.vendor_header.signature,
                    vendor_fingerprint,
                    V2_PROD_SIGS_REQUIRED,
                    V2_BOOTLOADER_KEYS,
                    fw.vendor_header.sigmask,
                )
        except Exception as exc:
            raise InvalidSignatureError("Invalid vendor header signature.") from exc
