...
let
  ...
  # support loading this file both directly as ci/shell.nix and via the
  # repository-root shell.nix symlink
  pyright = nixpkgs.callPackage (
    if builtins.pathExists ./pyright then ./pyright else ./ci/pyright
  ) {};
in
with nixpkgs;
